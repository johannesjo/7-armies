...
const WEIGHTS: Record<UnitType, {
  ...
  archer:    { distIdeal: [140, 250], distPenaltyScale: 0.15, los: 30, elevation: 25, cover: 20, flank: 5 },
  cavalry:   { distIdeal: [0, 50],    distPenaltyScale: 0.2,  los: 15, elevation: 5,  cover: 5,  flank: 30 },
  swordsman: { distIdeal: [0, 40],    distPenaltyScale: 0.2,  los: 15, elevation: 5,  cover: 10, flank: 20 },
  pikeman:   { distIdeal: [0, 40],    distPenaltyScale: 0.25, los: 10, elevation: 5,  cover: 15, flank: 10 },
};
